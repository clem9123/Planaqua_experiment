...
```{r}
print(Model_Treatment_capture)
print(Model_Treatment_capture_reverse)
traceplot(Model_Treatment_capture_reverse, ask = F)
autocorr.plot(Model_Treatment_capture_reverse,ask=F)
```
