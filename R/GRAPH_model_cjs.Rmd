...
ggplot(tbl)+
  geom_boxplot(aes(x = taille , y = phi, color = taille))

ggplot(tbl)+
  geom_boxplot(aes(x = taille , y = p, color = taille))
```
...
for (i in 1:6){
  for (t in 1:5){
    for (l in 1:16){
      tbl_p2 <- rbind(tbl_p2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect_p)[[1]][,paste("p[",as.character(i),",",as.character(t),",",as.character(l),"]", sep = "")],i,t,l))
    }
  
    for (tr in 1:4){
    tbl_phi2 <- rbind(tbl_phi2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect_p)[[1]][,paste("phi[",as.character(i),",",as.character(t),",",as.character(tr),"]", sep = "")],i,t,tr))
    }
  }
}
colnames(tbl_phi2) <- c("phi","taille","year","treatment")
...
for (i in 1:4){
  tbl_p2 <- rbind(tbl_p2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect)[[1]][,paste("p[",as.character(i),"]", sep = "")],i))
  for (t in 1:5){
    for (tr in 1:4){
    tbl_phi2 <- rbind(tbl_phi2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect)[[1]][,paste("phi[",as.character(i),",",as.character(tr),"]", sep = "")],i,tr)) #",",as.character(t),
    }
  }
}
#}
...
for (i in 1:4){
  tbl_p2 <- rbind(tbl_p2, 
               data.frame(as.mcmc(CJS_group_taille_trtcorrect)[[1]][,paste("p[",as.character(i),"]", sep = "")],i))
  for (t in 1:5){
    for (tr in 1:4){
    tbl_phi2 <- rbind(tbl_phi2, 
               data.frame(as.mcmc(CJS_group_taille_trtcorrect)[[1]][,paste("phi[",as.character(i),",",",",as.character(t),as.character(tr),"]", sep = "")],i,t,tr)) #
    }
  }
}
#}
