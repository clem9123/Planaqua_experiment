...
# Il reste des petites bosses peut-être à cause des différents lacs
...
```{r}
p1 <- ggplot(tbl5_psi %>% filter (year == "1"), aes(color = treatment))+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 1, treatment == "1"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 1, treatment == "2"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 1, treatment == "3"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 1, treatment == "4"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 1, treatment == "1"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 1, treatment == "2"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 1, treatment == "3"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 1, treatment == "4"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  ylim(c(0,1))+
  facet_wrap(~c)
p2 <- ggplot(tbl5_psi %>% filter (year == "2"), aes(color =treatment))+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 2, treatment == "1"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 2, treatment == "2"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 2, treatment == "3"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "1", year == 2, treatment == "4"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 2, treatment == "1"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 2, treatment == "2"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 2, treatment == "3"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_psi %>% filter(c == "2", year == 2, treatment == "4"),aes(x = treatment, y = mean(psi),ymin = quantile(psi, 0.025), ymax = quantile(psi, 0.975)),show.legend = F)+
  ylim(c(0,1))+
  facet_wrap(~c)
...
```{r}
p1 <- ggplot(tbl5_phi %>% filter (year == "1"), aes(color = size))+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 1, treatment == "1"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 1, treatment == "2"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 1, treatment == "3"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 1, treatment == "4"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 1, treatment == "1"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 1, treatment == "2"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 1, treatment == "3"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 1, treatment == "4"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 1, treatment == "1"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 1, treatment == "2"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 1, treatment == "3"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 1, treatment == "4"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  
  guides(color = element_blank())+
  ylim(c(0,1))+
  facet_wrap(~size)

p2 <- ggplot(tbl5_phi %>% filter (year == "2"), aes(color = size))+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 2, treatment == "1"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 2, treatment == "2"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 2, treatment == "3"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 1, year == 2, treatment == "4"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 2, treatment == "1"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 2, treatment == "2"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 2, treatment == "3"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 2, year == 2, treatment == "4"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 2, treatment == "1"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 2, treatment == "2"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 2, treatment == "3"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_phi %>% filter(size == 3, year == 2, treatment == "4"),aes(x = treatment, y = mean(phi),ymin = quantile(phi, 0.025), ymax = quantile(phi, 0.975)),show.legend = F)+
...
```{r}
p1 <- ggplot(tbl5_n %>% filter (size == "1"), aes(color = treatment))+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 1, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 2, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 3, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 4, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 5, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 6, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 1, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 2, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 3, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 4, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 5, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 6, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 1, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 2, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 3, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 4, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 5, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 6, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 1, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 2, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 3, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 4, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 5, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 1, year == 6, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 1, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 2, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 3, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 4, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 5, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 6, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 1, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 2, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 3, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 4, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 5, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 6, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 1, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 2, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 3, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 4, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 5, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 6, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 1, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 2, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 3, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 4, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 5, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 2, year == 6, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 1, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 2, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 3, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 4, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 5, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 6, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 1, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 2, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 3, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 4, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 5, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 6, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 1, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 2, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 3, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 4, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 5, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 6, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 1, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 2, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 3, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 4, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 5, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_n %>% filter(size == 3, year == 6, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
...
```{r}
p1 <- ggplot(tbl5_ntot, aes(color = treatment))+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 1, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 2, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 3, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 4, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 5, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 6, treatment == "1"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_ntot %>% filter(year == 1, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 2, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 3, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 4, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 5, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 6, treatment == "2"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_ntot %>% filter(year == 1, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 2, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 3, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 4, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 5, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 6, treatment == "3"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  
  geom_pointrange(data = tbl5_ntot %>% filter(year == 1, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 2, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 3, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 4, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 5, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)+
  geom_pointrange(data = tbl5_ntot %>% filter(year == 6, treatment == "4"),aes(x = year, y = mean(n),ymin = quantile(n, 0.025), ymax = quantile(n, 0.975)),show.legend = F)
