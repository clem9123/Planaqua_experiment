...
for (i in 1:6){
  for (t in 1:5){
    for (l in 1:16){
      tbl_p2 <- rbind(tbl_p2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect_p)[[1]][1:1000,paste("p[",as.character(i),",",as.character(t),",",as.character(l),"]", sep = "")],i,t,l))
    }
  
    for (tr in 1:4){
    tbl_phi2 <- rbind(tbl_phi2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect_p)[[1]][1:1000,paste("phi[",as.character(i),",",as.character(t),",",as.character(tr),"]", sep = "")],i,t,tr))
    }
  }
}
colnames(tbl_phi2) <- c("phi","taille","year","treatment")
...
for (i in 1:4){
  tbl_p2 <- rbind(tbl_p2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect)[[1]][1:200,paste("p[",as.character(i),"]", sep = "")],i))
  for (t in 1:5){
    for (tr in 1:4){
    tbl_phi2 <- rbind(tbl_phi2, 
               data.frame(as.mcmc(CJS_group_taille_trcorrect)[[1]][1:200,paste("phi[",as.character(i),",",as.character(t),",",as.character(tr),"]", sep = "")],i,t,tr))
    }
  }
}
#}
